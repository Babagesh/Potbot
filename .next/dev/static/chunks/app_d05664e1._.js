...
"[project]/app/config/backend.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const BACKEND_CONFIG = {
    ...
    PRODUCTION: {
        ...
        damageClassifyEndpoint: '/api/v1/classify',
        severityEndpoint: '/api/v1/severity',
        locationEndpoint: '/api/v1/locations'
    },
    // Development/Staging
    STAGING: {
...
const CURRENT_ENV = 'CURRENT'; // Change to 'PRODUCTION' or 'STAGING'
...
"[project]/app/services/backendService.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$config$2f$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/config/backend.ts [app-client] (ecmascript)");
;
class BackendService {
    config = (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$config$2f$backend$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCurrentConfig"])();
    /**
   ...
   */ async getResults(imageId) {
        ...
        const response = await fetch(`${this.config.baseUrl}${this.config.resultsEndpoint}/${imageId}`, {
            headers: {
            }
        });
        if (!response.ok) {
   ...
   */ async getHistory(limit = 50, offset = 0) {
        ...
        const response = await fetch(`${this.config.baseUrl}${this.config.historyEndpoint}?${params}`, {
            headers: {
            }
        });
        if (!response.ok) {
   ...
   */ async classifyDamage(imageId) {
        if (!this.config.damageClassifyEndpoint) {
            throw new Error('Damage classification endpoint not configured');
        }
        const response = await fetch(`${this.config.baseUrl}${this.config.damageClassifyEndpoint}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
   ...
   */ async assessSeverity(imageId) {
        if (!this.config.severityEndpoint) {
            throw new Error('Severity assessment endpoint not configured');
        }
        const response = await fetch(`${this.config.baseUrl}${this.config.severityEndpoint}`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
   ...
   */ async getLocationReports(latitude, longitude, radius = 1000 // meters
    ) {
        ...
        const response = await fetch(`${this.config.baseUrl}${this.config.locationEndpoint}?${params}`, {
            headers: {
            }
        });
        if (!response.ok) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$backendService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/services/backendService.ts [app-client] (ecmascript)");
;
...
function ImageUpload() {
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$services$2f$backendService$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["backendService"].uploadImage(selectedImage, metadata);
...
//# sourceMappingURL=app_d05664e1._.js.map
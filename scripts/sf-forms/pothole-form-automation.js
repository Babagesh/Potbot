...
/**
 * Pothole Form Automation - Step by Step Implementation
 */
class PotholeFormAutomation {
  constructor(options = {}) {
  ...
  async submitPotholeReport(formData) {
    console.log('🚧 Starting Pothole Form Submission');
    console.log('===================================');
  ...
  async testPotholeForm() {
    ...
    console.log('🧪 Testing Pothole Form with Sample Data');
    console.log('=======================================');
...
// Export the class
module.exports = { PotholeFormAutomation };

// Run test if this file is executed directly
if (require.main === module) {
  async function runPotholeTest() {
    const automation = new PotholeFormAutomation({ headless: false });
    ...
    try {
      ...
      const resultsPath = path.join(__dirname, 'pothole-form-test-results.json');
      fs.writeFileSync(resultsPath, JSON.stringify(result, null, 2));
      console.log(`\n💾 Test results saved to: ${resultsPath}`);
      
    } catch (error) {
      console.error('Pothole form test failed:', error);
    }
  }
